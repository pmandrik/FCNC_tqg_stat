...
make_hists_sm(){
  ...
  root -q -b -l "$cfgdir/tree_to_hists.C(\"SM\", \""$release" SIG\", \"hists_SM.root\", $nbins_, $QCD_norm_, $qcd_cut_)"
  ...
  # root -q -b -l "$cfgdir/tree_to_hists.C(\"SM\", \""$release" BACK\", \"hists_BG.root\", $nbins_, $QCD_norm_, $qcd_cut_)"
